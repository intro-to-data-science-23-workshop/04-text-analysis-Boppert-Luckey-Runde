...
**Exercise 9**: Look at the [canonical regex for validating email addresses](https://www.ex-parrot.com/~pdw/Mail-RFC822-Address.html) and think about when regexes are and are not appropriate.
...
**Exercise 11** You are now processing 
